...
import { X, Save, Calendar, Tag, Box } from "lucide-react";
...
interface EditFoodModalProps {
  ...
  item: FoodItem | null;
  onClose: () => void;
  onUpdateFood: (updatedItem: FoodItem) => void;
}
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/50 backdrop-blur-xs">
        ...
        >
          ...
          <div className="px-6 py-5 bg-[#0F172A] text-white border-b border-slate-800 flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-widest text-[#22C55E] font-bold">Update Inventory</p>
              <h3 className="text-xl font-serif italic text-white">Edit Food Item</h3>
            </div>
            <button
              onClick={onClose}
